...
---requiere: { n ≥ 0 }
---asegura: { resultado = true ↔ n es algun valor de la secuencia de Fibonacci, false en caso contrario }
---}
esFibonacci :: Integer -> Bool
esFibonacci n | n == 0 = True
              | n == 1 = True
              | otherwise = esFibonacciAux n 0 1
esFibonacciAux :: Integer -> Integer -> Integer -> Bool
esFibonacciAux n a b | b == n = True
                  | b > n = False
                  | otherwise = esFibonacciAux n b (a + b)
---
esFibonacci2:: Integer -> Bool
esFibonacci2 n | n == 0 = True
              | n == 1 = True
              | otherwise = esFibonacciAux2 n 1
---
esFibonacciAux2 :: Integer -> Integer -> Bool
