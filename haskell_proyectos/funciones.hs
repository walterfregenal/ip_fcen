...
------
absZ :: Integer -> Integer
absZ  n | n >= 0 = n 
        | otherwise = -n  
---        
sumaUltimosDosDigitos :: Integer -> Integer
sumaUltimosDosDigitos n = mod (absZ n) 10 + mod ( div (absZ n) 10) 10
----
...
-- problema f4 (a,b : R) : R {
  --requiere : {True}
  --asegura : { res es la media de a y b} 
  -- }
--- problema f5 :: (a: RxR) : R {
--  requiere : {True}
--  asegura : { res es la media de elFst a  y elSnd b }}
--- problema   